# PagerDuty.ApiClient.Api.VendorsApi

All URIs are relative to *https://api.pagerduty.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**GetVendor**](VendorsApi.md#getvendor) | **GET** /vendors/{id} | Get a vendor
[**ListVendors**](VendorsApi.md#listvendors) | **GET** /vendors | List vendors

<a name="getvendor"></a>
# **GetVendor**
> Object GetVendor (string accept, string contentType, string authorization, string id)
...
namespace Example
{
    public class GetVendorExample
    {
        public void main()
        {
            ...
            {
                // Get a vendor
                Object result = apiInstance.GetVendor(accept, contentType, authorization, id);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
                Debug.Print("Exception when calling VendorsApi.GetVendor: " + e.Message );
            }
        }
    }
}
...
<a name="listvendors"></a>
# **ListVendors**
> Object ListVendors (string accept, string contentType, string authorization, int? limit = null, int? offset = null, bool? total = null)
...
namespace Example
{
    public class ListVendorsExample
    {
        public void main()
        {
            // Configure API key authorization: api_key
            ...
            {
                // List vendors
                Object result = apiInstance.ListVendors(accept, contentType, authorization, limit, offset, total);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
                Debug.Print("Exception when calling VendorsApi.ListVendors: " + e.Message );
            }
        }
    }
}
