# PagerDuty.ApiClient.Api.PrioritiesApi

All URIs are relative to *https://api.pagerduty.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**ListPriorities**](PrioritiesApi.md#listpriorities) | **GET** /priorities | List priorities

<a name="listpriorities"></a>
# **ListPriorities**
> Object ListPriorities (string accept, string contentType, string authorization, int? limit = null, int? offset = null, bool? total = null)
...
namespace Example
{
    public class ListPrioritiesExample
    {
        public void main()
        {
            ...
            var apiInstance = new PrioritiesApi();
            ...
            {
                // List priorities
                Object result = apiInstance.ListPriorities(accept, contentType, authorization, limit, offset, total);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
                Debug.Print("Exception when calling PrioritiesApi.ListPriorities: " + e.Message );
            }
        }
    }
}
