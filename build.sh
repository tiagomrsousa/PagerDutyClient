...
${nuget_cmd} install src/PagerDuty.ApiClient/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/PagerDuty.ApiClient.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/PagerDuty.ApiClient.dll \
-recurse:'src/PagerDuty.ApiClient/*.cs' \
-doc:bin/PagerDuty.ApiClient.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/PagerDuty.ApiClient.dll was created successfully"
fi
