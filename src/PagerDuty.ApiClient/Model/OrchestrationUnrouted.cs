...
namespace PagerDuty.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OrchestrationUnrouted :  IEquatable<OrchestrationUnrouted>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrchestrationUnrouted" /> class.
        /// </summary>
        /// <param name="orchestrationPath">orchestrationPath.</param>
        public OrchestrationUnrouted(Object orchestrationPath = default(Object))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OrchestrationUnrouted {\n");
        ...
        {
            return this.Equals(input as OrchestrationUnrouted);
        }

        /// <summary>
        /// Returns true if OrchestrationUnrouted instances are equal
        /// </summary>
        /// <param name="input">Instance of OrchestrationUnrouted to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrchestrationUnrouted input)
        {
            if (input == null)
                return false;
