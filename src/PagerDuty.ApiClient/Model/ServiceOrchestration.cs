...
namespace PagerDuty.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ServiceOrchestration :  IEquatable<ServiceOrchestration>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceOrchestration" /> class.
        /// </summary>
        /// <param name="orchestrationPath">orchestrationPath.</param>
        public ServiceOrchestration(Object orchestrationPath = default(Object))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceOrchestration {\n");
        ...
        {
            return this.Equals(input as ServiceOrchestration);
        }

        /// <summary>
        /// Returns true if ServiceOrchestration instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceOrchestration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceOrchestration input)
        {
            if (input == null)
                return false;
