...
namespace PagerDuty.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AuditRecordResponseSchema :  IEquatable<AuditRecordResponseSchema>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditRecordResponseSchema" /> class.
        /// </summary>
        public AuditRecordResponseSchema()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuditRecordResponseSchema {\n");
        ...
        {
            return this.Equals(input as AuditRecordResponseSchema);
        }

        /// <summary>
        /// Returns true if AuditRecordResponseSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of AuditRecordResponseSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuditRecordResponseSchema input)
        {
            if (input == null)
                return false;
