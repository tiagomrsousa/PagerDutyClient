...
namespace PagerDuty.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class EscalateLogEntry : LogEntry,  IEquatable<EscalateLogEntry>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EscalateLogEntry {\n");
        ...
        {
            return this.Equals(input as EscalateLogEntry);
        }

        /// <summary>
        /// Returns true if EscalateLogEntry instances are equal
        /// </summary>
        /// <param name="input">Instance of EscalateLogEntry to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EscalateLogEntry input)
        {
            if (input == null)
                return false;
