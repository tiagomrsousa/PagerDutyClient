...
namespace PagerDuty.ApiClient.Model
{
        ...
        public partial class Assignment :  IEquatable<Assignment>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="at">Time at which the assignment was created. (required).</param>
        /// <param name="assignee">assignee (required).</param>
        public Assignment(DateTime? at = default(DateTime?), UserReference assignee = default(UserReference))
        {
            // to ensure "at" is required (not null)
            if (at == null)
            {
                throw new InvalidDataException("at is a required property for Assignment and cannot be null");
            }
            else
            {
                this.At = at;
            ...
            if (assignee == null)
            {
                throw new InvalidDataException("assignee is a required property for Assignment and cannot be null");
            }
            else
            {
