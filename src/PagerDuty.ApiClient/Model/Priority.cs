...
namespace PagerDuty.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class Priority :  IEquatable<Priority>, IValidatableObject
    {
        /// <summary>
        ...
        public Priority(string name = default(string), string description = default(string))
        {
            this.Name = name;
        ...
        /// <returns>Boolean</returns>
        public bool Equals(Priority input)
        {
            if (input == null)
                return false;
